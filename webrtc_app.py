...
if app_mode == 'Home':
    ...
    st.markdown('This web-application utilises **InsightFace** to blur all faces in an input image or video.\
        Then, **MoveNet** is used to perform **pose estimation** on the image/video. \
